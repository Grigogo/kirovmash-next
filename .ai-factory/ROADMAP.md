...
- [ ] **i18n Infrastructure** — Set up next-intl routing, middleware, translation files, and utility functions
...
- [ ] **SEO & Performance** — Add metadata, sitemap, optimize images, improve Core Web Vitals
...
| 2 | i18n Infrastructure | 🔄 Partial | lib/i18n.ts exists but no next-intl, middleware, translation files |
...
| 14 | SEO & Performance | ⏳ Not Started | No metadata, sitemap, optimization |
